...
export const saveShopifyAccessToken = {
  async saveShopifyAccessToken(_: any, { id, accessToken, shopId }, context: any) {
    ...
    var patch = {
      accessToken,
      refreshToken: '',
      accessInfo: JSON.stringify({ shopId, accessToken }, null, 2),
      storeId: shopId,
      status: 'active'
    }
